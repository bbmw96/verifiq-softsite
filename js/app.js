...
const App = (() => {
  ...
  function renderRulesPage() {
    ...
    return `<div>
      ...
      <p style="color:var(--mid-grey);font-size:13px;margin-bottom:12px">
        <strong>206 IFC+SG classification codes</strong> embedded across architectural, structural,
        M&amp;E, plumbing, civil and landscape disciplines, plus full Malaysia NBeS codes.
        ...
        <div class="two-col">
          <div class="card">
            ...
            <div style="font-size:12px;line-height:1.8">
              ...
              <b>Agencies:</b> BCA · SCDF · URA · PUB · LTA · HDB · SLA · NEA · NParks · JTC<br>
  ...
  function renderAgencyRules() {
    const agencies = [
      ...
      {id:'NParks', name:'National Parks Board',
       rules:['Greenery Provision Ratio (GnPR) targets', 'Landscape Replacement Plan (LRP) area', 'Heritage tree conservation and root protection zones', 'IfcGeographicElement vegetation - Species, Girth, Status']},
      {id:'SLA',  name:'Singapore Land Authority',
       rules:['SVY21 georeferencing (EPSG:3414) - mandatory IfcMapConversion', 'Survey boundaries and land parcel extents', 'True north and coordinate reference alignment']},
      {id:'HDB',  name:'Housing & Development Board',
       rules:['Public housing dwelling sizes (living/dining min 16m²)', 'Lift lobby and common corridor clearances', 'Void deck and precinct facility provision']},
      {id:'JTC',  name:'JTC Corporation',
       rules:['Industrial floor loading capacity', 'Permitted industrial use and B1/B2 zoning', 'JTC development control and plot requirements']},
    ];
  ...
  function renderCheckLevels() {
    const levels = [
      ...
      [7,'SGPset_ / Classification Chain','Validates all SGPset_ property sets. When a classification code is present, checks ALL code-specific required property sets from the embedded 206-code library (e.g. A-WAL-EXW triggers SGPset_WallThermal checks; A-DOR-FRD triggers SGPset_DoorFireDoor checks).'],
  ...
  function renderUserGuidePage() {
    return `<div>
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
            <div style="background:rgba(255,255,255,.08);border-radius:6px;padding:10px">
              ...
              <div style="font-size:11px;color:#CBD5E1;line-height:1.7">
                ...
                data types, and enumeration constraints - checked against all 10 Singapore CORENET-X agencies
      ...
      <div class="card" id="ug-9" style="margin-top:12px">
        ...
        <div style="font-size:12px;line-height:1.8;color:var(--mid-grey)">
          ...
          <ul style="padding-left:20px;line-height:1.9;margin-top:6px">
            ...
            <li><strong>Agency Risk Table</strong> - all 10 SG agencies rated HIGH/MEDIUM/LOW/CLEAR</li>
      ...
      <div class="card" id="ug-10" style="margin-top:12px">
        <div class="card-header"><span class="card-title">11. Classification Library - 206 IFC+SG Codes with Exact Property Rules</span></div>
        <div style="font-size:12px;line-height:1.8;color:var(--mid-grey)">
          <p>VERIFIQ embeds 206 IFC+SG classification codes (COP 3.1, 2025). For every code, VERIFIQ knows exactly
  ...
  function _exportScoreChart(session) {
    ...
    const agencyRows = Object.entries(agencyCounts).sort((a,b)=>b[1]-a[1]).slice(0,10).map(([ag, n]) => {
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
        ...
        <div class="card" style="padding:20px" id="rules-update-card">
          ...
          <div style="font-size:10px;color:var(--mid-grey);margin-top:10px;line-height:1.6">
            ...
            206 classification codes and 962 property rules across the Singapore checking agencies, within the full 10-agency CORENET-X framework.
          </div>
        </div>
...
const WelcomeTour = (() => {
  ...
  const STEPS = [
    ...
    { icon:'B', title:'Step 10: Rules Database',
      body:'Browse all embedded rules: IFC+SG property set requirements for every COP 3.1 entity type, all 206 classification codes (81 identified components), Singapore agency requirements by entity (BCA/URA/SCDF/LTA/PUB/NEA/NParks/SLA/HDB/JTC), UBBL 1984 Malaysia rules, all 20 check level descriptions, and the complete design code parameter list.',
      nav:'rules' },
    // Step 11 - Settings
    ...
    const SECTIONS = [
      ...
      },
      {
        ...
        content:`
          ...
          <p>Singapore CORENET-X submissions are reviewed by up to 10 agencies simultaneously. Each agency checks specific elements and properties:</p>
          <table class="manual-table">
            ...
            <tr><td><strong>NParks</strong></td><td>National Parks Board</td><td>IfcGeographicElement (vegetation), IfcSpace (landscape)</td><td>SGPset_Landscape, Greenery Provision (GnPR), heritage tree data</td></tr>
            <tr><td><strong>HDB</strong></td><td>Housing &amp; Development Board</td><td>IfcSpace (dwelling), IfcBuildingStorey</td><td>Dwelling unit sizes, lift lobby and corridor clearances, void deck</td></tr>
          </table>`
      },
      {
