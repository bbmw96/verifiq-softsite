...
const EmbeddedAI = (() => {
  ...
  const SG_GATEWAYS = {
    ...
    G3: {
      ...
      agencies: ['BCA','URA','SCDF','NEA','PUB','LTA','HDB','SLA','NParks','JTC'],
  ...
  function answer(question, context) {
    ...
    const agMap = { bca:'BCA', ura:'URA', scdf:'SCDF', nea:'NEA', pub:'PUB', lta:'LTA', hdb:'HDB', sla:'SLA', nparks:'NParks', jtc:'JTC' };
  ...
  function _fmtAgency(agency) {
    ...
    const slaMap = { BCA:'15 WD (independent)', URA:'20 WD (joint)', SCDF:'5 WD (independent)', NEA:'20 WD (independent)', PUB:'14 WD drainage / 21 WD sewerage', LTA:'20 WD (independent)', HDB:'20 WD (G3 only)', SLA:'20 WD (G3 only)', NParks:'20 WD (independent)', JTC:'20 WD (G3 only)' };
    const gwMap  = { BCA:'G-/G1/G1.5/G2/DSP/G3', URA:'G1/G2/G3', SCDF:'G1/G2/G3', NEA:'G1/G2/G3', PUB:'G2/G3', LTA:'G1/G2/G3', HDB:'G3', SLA:'G3', NParks:'G1/G1.5/G2/G3', JTC:'G3' };
